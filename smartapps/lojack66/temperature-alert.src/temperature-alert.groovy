...
preferences {
    ...
    {
    		input "maxThreshold", "number",   title: "if above... (default 40°)", defaultValue:40,   required: true
            input "minThreshold", "number",   title: "if below... (default 05°)", defaultValue:05,   required: true
    }
